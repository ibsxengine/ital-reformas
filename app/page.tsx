...
export default function Home() {
  ...
  const handleContacto = (e: React.MouseEvent) => {
    e.preventDefault();
    setMenuOpen(false);
  ...
  return (
    <main style={{ fontFamily: "'Jost', sans-serif" }} className="bg-[#FAFAF5] text-[#0E0E0C] overflow-x-hidden">
      ...
      <motion.header
        ...
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8 py-4 sm:py-5 flex items-center justify-between">
          <Link href="/"
            ...
            <span className={`font-display font-light tracking-[0.13em] sm:tracking-[0.18em] text-lg sm:text-2xl transition-colors duration-500 ${scrolled ? "text-[#0E0E0C]" : "text-[#FAFAF5]"}`}>
          ...
          <motion.div
            ...
            {NAV.map((l, i) => (
              <motion.div key={l.label} initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.08 + 0.2 }}>
                {l.label === "Contacto" ? (
                  <a href="#contacto" onClick={handleContacto}
                  ...
                  <Link href={l.href}
                    onClick={() => { setMenuOpen(false); if (!l.href.includes('#')) setTimeout(() => window.scrollTo({ top: 0, behavior: 'smooth' }), 100); }}
                    className="block font-display font-light text-[#FAFAF5] py-4 border-b border-[#FAFAF5]/8 hover:text-[#8B1A2A] transition-colors"
                    style={{ fontFamily: "'Cormorant', serif", fontSize: "clamp(1.8rem, 7vw, 3.5rem)" }}>
                    {l.label}
                  </Link>
      ...
      <section className="relative h-screen min-h-[600px] overflow-hidden">
        ...
        <div className="absolute left-4 sm:left-8 top-1/2 -translate-y-1/2 h-28 sm:h-36 flex flex-col gap-0.5 z-10">
          <div className="flex-1 w-[3px] bg-[#1C3D2E]" />
        ...
        <motion.div style={{ opacity: heroOpacity }}
          className="relative z-10 h-full flex flex-col justify-end max-w-[1360px] mx-auto px-5 sm:px-8 pb-20 sm:pb-28">
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4, duration: 0.8 }}
            className="text-[10px] sm:text-[11px] tracking-[0.28em] sm:tracking-[0.38em] uppercase text-[#FAFAF5]/45 mb-5 sm:mb-7 font-light">
          ...
          <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }}
            ...
            className="flex flex-col sm:flex-row gap-0 w-full sm:w-fit">
            <Link href="/servicios"
              className="inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-5 bg-[#1C3D2E] border border-[#1C3D2E] text-[#FAFAF5] text-[11px] sm:text-[12px] tracking-[0.22em] uppercase font-light hover:brightness-125 transition-all duration-500">
              Nuestros servicios
            </Link>
            <Link href="/proyectos"
              className="inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-5 bg-[#E8E8E5] border border-[#E8E8E5] text-[#0E0E0C] text-[11px] sm:text-[12px] tracking-[0.22em] uppercase font-light hover:bg-[#D8D8D4] transition-all duration-500">
              Ver proyectos
            </Link>
            <a href="#contacto"
              className="inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-5 bg-[#8B1A2A] border border-[#8B1A2A] text-[#FAFAF5] text-[11px] sm:text-[12px] tracking-[0.22em] uppercase font-light hover:brightness-125 transition-all duration-500">
              Presupuesto gratis
            </a>
          </motion.div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.2 }}
          className="absolute bottom-9 right-5 sm:right-9 flex flex-col items-center gap-2 z-10">
      ...
      {/* STATS */}
      <section ref={statsS.ref} className="py-12 sm:py-20 bg-[#1C3D2E]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8 grid grid-cols-2 md:grid-cols-4 divide-x divide-[#FAFAF5]/10">
          {STATS.map((s, i) => (
            <motion.div key={s.label} {...fadeUp(i * 0.1, statsS.inView)} className="px-4 sm:px-8 py-6 sm:py-8 text-center group">
              <div className="font-display text-4xl sm:text-5xl md:text-6xl font-light text-[#FAFAF5] mb-1 sm:mb-2 group-hover:text-[#8B1A2A] transition-colors duration-500">{s.num}</div>
              <div className="text-[9px] sm:text-[10px] tracking-[0.18em] sm:tracking-[0.22em] uppercase text-[#FAFAF5]/55 font-light">{s.label}</div>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      {/* NOSOTROS */}
      <section id="nosotros" ref={nosotrosS.ref} className="py-16 sm:py-40 bg-[#FAFAF5]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8 grid md:grid-cols-2 gap-10 sm:gap-20 items-center">
          <motion.div className="relative img-zoom"
            ...
            <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1000&q=90"
              alt="Equipo Ital Reformas" className="w-full h-[260px] sm:h-[580px] object-cover" />
            ...
            <div className="absolute top-5 sm:top-7 right-5 sm:right-7 bg-[#FAFAF5]/95 backdrop-blur px-4 sm:px-5 py-2 sm:py-3 border-l-2 border-[#8B1A2A]">
              <p className="text-[10px] tracking-[0.2em] uppercase text-[#0E0E0C]/45">Desde</p>
              <p className="font-display text-xl sm:text-2xl font-light text-[#0E0E0C]">2012</p>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 60 }} animate={nosotrosS.inView ? { opacity: 1, x: 0 } : {}}
            ...
            <p className="text-[11px] tracking-[0.32em] uppercase text-[#8B1A2A] mb-5 sm:mb-7">Sobre nosotros</p>
            <h2 className="font-display leading-[1.02] mb-6 sm:mb-9 text-[#0E0E0C]" style={{ fontSize: "clamp(2rem, 4.5vw, 4.5rem)" }}>
              Precisión italiana.<br /><span className="italic text-[#1C3D2E]">Compromiso total.</span>
            </h2>
            <p className="text-[#0E0E0C]/70 font-light leading-[1.95] text-base sm:text-lg mb-4 sm:mb-5">
            ...
            <p className="text-[#0E0E0C]/50 font-light leading-[1.95] text-sm sm:text-base">
            ...
            <div className="mt-8 sm:mt-10 flex gap-1">
              <div className="w-12 h-[3px] bg-[#1C3D2E]" /><div className="w-12 h-[3px] bg-[#0E0E0C]/10" /><div className="w-12 h-[3px] bg-[#8B1A2A]" />
            </div>
            <Link href="/nosotros" className="mt-8 sm:mt-10 inline-flex items-center gap-4 text-[12px] tracking-[0.22em] uppercase font-light text-[#0E0E0C] hover:text-[#8B1A2A] transition-colors group">
      ...
      {/* SERVICIOS */}
      <section id="servicios" ref={serviciosS.ref} className="py-16 sm:py-36 bg-[#1A1A18]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
          <motion.div {...fadeUp(0, serviciosS.inView)} className="mb-10 sm:mb-20 flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6">
            <div>
              <p className="text-[11px] tracking-[0.32em] uppercase text-[#8B1A2A] mb-4 sm:mb-5">Lo que hacemos</p>
              <h2 className="font-display font-light text-[#FAFAF5] leading-tight" style={{ fontSize: "clamp(2.5rem, 6vw, 6rem)" }}>
                Nuestros<br />
                <span className="italic" style={{ WebkitTextStroke: "1px #8B1A2A", color: "transparent" }}>servicios.</span>
              </h2>
            </div>
            <Link href="/servicios" className="text-[12px] tracking-[0.18em] uppercase font-light text-[#FAFAF5]/40 hover:text-[#8B1A2A] transition-colors self-start md:self-end group inline-flex items-center gap-3">
          ...
          <div className="divide-y divide-[#FAFAF5]/8">
            {SERVICIOS_PREVIEW.map((s, i) => (
              <motion.div key={s.id} {...fadeUp(i * 0.1, serviciosS.inView)}
                className="service-line group py-7 sm:py-11 grid grid-cols-12 gap-4 sm:gap-6 items-center relative overflow-hidden cursor-pointer"
                ...
                <div className="col-span-12 md:col-span-4">
                  <h3 className="font-display font-light text-[#FAFAF5] group-hover:text-[#8B1A2A] transition-colors leading-tight" style={{ fontSize: "clamp(1.5rem, 3vw, 2.8rem)" }}>{s.title}</h3>
                </div>
                <div className="col-span-12 md:col-span-5">
                  <p className="text-[#FAFAF5]/70 font-light text-sm sm:text-lg leading-relaxed group-hover:text-[#FAFAF5]/90 transition-colors">{s.desc}</p>
                </div>
          ...
          <motion.div {...fadeUp(0.4, serviciosS.inView)} className="mt-8 sm:mt-12 text-center">
            <Link href="/servicios"
              className="inline-flex items-center gap-4 px-8 sm:px-10 py-4 border border-[#FAFAF5]/20 text-[#FAFAF5] text-[11px] sm:text-[12px] tracking-[0.22em] uppercase font-light hover:bg-[#8B1A2A] hover:border-[#8B1A2A] transition-all duration-500">
      ...
      {/* POR QUÉ ELEGIRNOS */}
      <section ref={razonesS.ref} className="py-16 sm:py-36 bg-[#FFFFFF]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
          <motion.div {...fadeUp(0, razonesS.inView)} className="mb-10 sm:mb-16 text-center">
            <p className="text-[11px] tracking-[0.32em] uppercase text-[#8B1A2A] mb-4 sm:mb-5">Por qué elegirnos</p>
            <h2 className="font-display font-light text-[#0E0E0C]" style={{ fontSize: "clamp(2rem, 5vw, 5rem)" }}>
              La diferencia <span className="italic text-[#1C3D2E]">Ital.</span>
            </h2>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#0E0E0C]/8">
            {RAZONES.map((r, i) => (
              <motion.div key={r.title} {...fadeUp(i * 0.1, razonesS.inView)}
                className="bg-[#FFFFFF] p-6 sm:p-10 group hover:bg-[#1C3D2E] transition-all duration-500">
                <div className="text-2xl sm:text-3xl mb-4 sm:mb-5 group-hover:scale-110 transition-transform duration-300"
                  style={{ filter: "sepia(1) saturate(3) hue-rotate(310deg) brightness(0.6)" }}>
                  {r.icon}
                </div>
                <h3 className="font-display text-xl sm:text-2xl font-light text-[#0E0E0C] group-hover:text-[#FAFAF5] transition-colors duration-400 mb-2 sm:mb-3">{r.title}</h3>
                <p className="text-[#0E0E0C]/60 font-light text-xs sm:text-sm leading-relaxed group-hover:text-[#FAFAF5]/80 transition-colors duration-400">{r.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* PROYECTOS */}
      <section id="proyectos" ref={proyectosS.ref} className="py-16 sm:py-40 bg-[#F2F2F0]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
          <motion.div {...fadeUp(0, proyectosS.inView)} className="mb-10 sm:mb-20 flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6">
            <div>
              <p className="text-[11px] tracking-[0.32em] uppercase text-[#8B1A2A] mb-4 sm:mb-5">Nuestro trabajo</p>
              <h2 className="font-display font-light text-[#0E0E0C] leading-tight" style={{ fontSize: "clamp(2.5rem, 7vw, 7rem)" }}>
                Proyectos<br /><span className="italic text-[#1C3D2E]">que hablan.</span>
              </h2>
            </div>
            <Link href="/proyectos" className="text-[12px] tracking-[0.18em] uppercase font-light text-[#0E0E0C]/40 hover:text-[#8B1A2A] transition-colors self-start md:self-end group inline-flex items-center gap-3">
              Ver todos <span className="w-6 h-px bg-current group-hover:w-10 transition-all duration-300" />
            </Link>
          </motion.div>
          <div className="grid md:grid-cols-12 gap-3 sm:gap-4">
            {PROYECTOS_PREVIEW.map((p, i) => (
              <motion.div key={p.title}
                ...
                <div className={`relative ${p.large ? "h-[240px] sm:h-[520px]" : "h-[180px] sm:h-[380px]"} overflow-hidden`}>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-8 flex items-end justify-between">
                    <div>
                      <p className="text-[10px] tracking-[0.25em] uppercase text-[#8B1A2A] mb-1 sm:mb-2">{p.cat} · {p.year}</p>
                      <h3 className="font-display font-light text-[#FAFAF5] leading-tight" style={{ fontSize: "clamp(1.1rem, 3vw, 2.2rem)" }}>{p.title}</h3>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          <motion.div {...fadeUp(0.4, proyectosS.inView)} className="mt-8 sm:mt-12 text-center">
            <Link href="/proyectos"
              className="inline-flex items-center gap-4 px-8 sm:px-10 py-4 bg-[#1C3D2E] text-[#FAFAF5] text-[11px] sm:text-[12px] tracking-[0.22em] uppercase font-light hover:bg-[#8B1A2A] transition-all duration-500">
      ...
      {/* PROCESO */}
      <section ref={procesoS.ref} className="py-16 sm:py-36 bg-[#1C3D2E]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
          <motion.div {...fadeUp(0, procesoS.inView)} className="mb-10 sm:mb-20 text-center">
            <p className="text-[12px] tracking-[0.32em] uppercase text-[#C0192E] mb-4 sm:mb-5 font-semibold">Cómo trabajamos</p>
            <h2 className="font-display font-light text-[#FAFAF5]" style={{ fontSize: "clamp(2rem, 5vw, 5rem)" }}>
              Proceso <span className="italic">transparente.</span>
            </h2>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-0 relative">
            <div className="absolute top-7 left-[12%] right-[12%] h-px bg-[#FAFAF5]/15 hidden md:block" />
            {PROCESO.map((p, i) => (
              <motion.div key={p.num} {...fadeUp(i * 0.12, procesoS.inView)} className="relative px-4 sm:px-8 py-4 sm:py-6 text-center group">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full border-2 border-[#C0192E]/70 flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:border-[#C0192E] group-hover:bg-[#C0192E]/15 transition-all duration-400 relative z-10 bg-[#1C3D2E]">
                  <span className="font-display text-lg sm:text-xl font-light text-[#C0192E] group-hover:text-[#FAFAF5] transition-colors">{p.num}</span>
                </div>
                <h3 className="font-display text-lg sm:text-2xl font-light text-[#FAFAF5] mb-2 sm:mb-4 group-hover:text-[#8B1A2A] transition-colors duration-400">{p.title}</h3>
                <p className="text-[#FAFAF5]/80 font-light text-xs sm:text-base leading-relaxed">{p.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-16 sm:py-28 bg-[#8B1A2A] relative overflow-hidden">
        ...
        <div className="relative max-w-[1360px] mx-auto px-5 sm:px-8 text-center">
          <p className="text-[11px] tracking-[0.35em] uppercase text-[#FAFAF5]/50 mb-4 sm:mb-6">¿Lista tu comunidad?</p>
          <h2 className="font-display font-light text-[#FAFAF5] mb-2 sm:mb-3" style={{ fontSize: "clamp(1.8rem, 6vw, 6rem)" }}>¿Tu comunidad necesita</h2>
          <h2 className="font-display font-light italic text-[#FAFAF5] mb-8 sm:mb-12" style={{ fontSize: "clamp(1.8rem, 6vw, 6rem)" }}>una reforma?</h2>
          <a href="https://wa.me/34653046233?text=Hola%2C%20quiero%20información%20sobre%20una%20reforma" target="_blank"
            className="inline-flex items-center gap-3 sm:gap-4 px-7 sm:px-10 py-4 sm:py-5 bg-[#FAFAF5] text-[#8B1A2A] text-[11px] sm:text-[12px] tracking-[0.22em] uppercase font-medium hover:bg-[#0E0E0C] hover:text-[#FAFAF5] transition-all duration-500">
            <svg viewBox="0 0 24 24" className="w-4 h-4 sm:w-5 sm:h-5 fill-current flex-shrink-0"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" /></svg>
      ...
      {/* TESTIMONIOS */}
      <section ref={testimoniosS.ref} className="py-16 sm:py-40 bg-[#FAFAF5]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
          <motion.div {...fadeUp(0, testimoniosS.inView)} className="mb-10 sm:mb-16 flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6">
            <div>
              <p className="text-[11px] tracking-[0.32em] uppercase text-[#8B1A2A] mb-4 sm:mb-5">Lo que dicen</p>
              <h2 className="font-display font-light text-[#0E0E0C]" style={{ fontSize: "clamp(2rem, 5vw, 5rem)" }}>
                Opiniones <span className="italic text-[#1C3D2E]">reales.</span>
              </h2>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex gap-0.5">{[1,2,3,4,5].map(i => <span key={i} className="text-[#8B1A2A] text-lg sm:text-xl">★</span>)}</div>
              <span className="font-display text-xl sm:text-2xl font-light text-[#0E0E0C]">4.9</span>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            {TESTIMONIOS.map((t, i) => (
              <motion.div key={t.name}
                ...
                className="group p-6 sm:p-9 border border-[#0E0E0C]/8 hover:border-[#8B1A2A]/30 hover:bg-[#F0EDE4] transition-all duration-500">
                <div className="flex items-start justify-between mb-4 sm:mb-6">
                  <Stars count={t.stars} />
                  <span className="text-[10px] tracking-[0.2em] uppercase text-[#0E0E0C]/30 font-light">Google</span>
                </div>
                <p className="font-display text-lg sm:text-xl font-light text-[#0E0E0C]/75 leading-[1.65] mb-5 sm:mb-7 italic">"{t.text}"</p>
                <div className="flex items-center gap-3 sm:gap-4 pt-4 sm:pt-5 border-t border-[#0E0E0C]/8">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#1C3D2E] flex items-center justify-center flex-shrink-0">
                    <span className="font-display text-base sm:text-lg font-light text-[#FAFAF5]">{t.name[0]}</span>
                  </div>
                  <div>
      ...
      {/* CONTACTO */}
      <section id="contacto" ref={contactoS.ref} className="py-16 sm:py-40 bg-[#0E0E0C]">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
          <motion.div {...fadeUp(0, contactoS.inView)} className="mb-10 sm:mb-20">
            <p className="text-[11px] tracking-[0.32em] uppercase text-[#8B1A2A] mb-4 sm:mb-6">Hablemos</p>
            <h2 className="font-display font-light text-[#FAFAF5] leading-tight" style={{ fontSize: "clamp(2.2rem, 7vw, 7rem)" }}>
              Tu proyecto,<br /><span className="italic text-[#8B1A2A]">nuestra misión.</span>
            </h2>
          </motion.div>
          <div className="grid md:grid-cols-12 gap-10 sm:gap-20">
            <motion.form className="md:col-span-7 space-y-5 sm:space-y-7" {...fadeUp(0, contactoS.inView)} onSubmit={e => e.preventDefault()}>
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {[{ p: "Nombre", t: "text" }, { p: "Teléfono", t: "tel" }].map(f => (
                  <input key={f.p} type={f.t} placeholder={f.p}
                    className="w-full bg-transparent border-b-2 border-[#FAFAF5]/20 text-[#FAFAF5] placeholder-[#FAFAF5]/50 py-3 sm:py-4 text-base font-light focus:outline-none focus:border-[#8B1A2A] transition-colors" />
                ))}
              </div>
              <input type="email" placeholder="Email" className="w-full bg-transparent border-b-2 border-[#FAFAF5]/20 text-[#FAFAF5] placeholder-[#FAFAF5]/50 py-3 sm:py-4 text-base font-light focus:outline-none focus:border-[#8B1A2A] transition-colors" />
              <select className="w-full bg-transparent border-b-2 border-[#FAFAF5]/20 text-[#FAFAF5]/70 py-3 sm:py-4 text-base font-light focus:outline-none focus:border-[#8B1A2A] transition-colors appearance-none">
              ...
              <textarea placeholder="Describe tu proyecto..." rows={4}
                className="w-full bg-transparent border-b-2 border-[#FAFAF5]/20 text-[#FAFAF5] placeholder-[#FAFAF5]/50 py-3 sm:py-4 text-base font-light focus:outline-none focus:border-[#8B1A2A] transition-colors resize-none" />
              <button type="submit" className="w-full py-4 sm:py-5 bg-[#8B1A2A] text-[#FAFAF5] text-[11px] tracking-[0.28em] uppercase font-light hover:bg-[#FAFAF5] hover:text-[#0E0E0C] transition-all duration-500">
                Solicitar presupuesto gratuito →
              </button>
            </motion.form>
            <motion.div className="md:col-span-5 space-y-7 sm:space-y-10" {...fadeUp(0.18, contactoS.inView)}>
              {[
                ...
                <div key={item.label} className="group pb-6 sm:pb-8 border-b border-[#FAFAF5]/8">
                  <p className="text-[10px] tracking-[0.28em] uppercase text-[#8B1A2A] mb-2 sm:mb-3">{item.label}</p>
                  <p className="font-display text-xl sm:text-2xl font-light text-[#FAFAF5] whitespace-pre-line group-hover:text-[#8B1A2A] transition-colors duration-300">{item.value}</p>
                </div>
              ))}
              <div className="flex gap-5 sm:gap-7 pt-1 sm:pt-2">
                {[
      ...
      {/* FOOTER */}
      <footer className="bg-[#0E0E0C] border-t border-[#FAFAF5]/5 py-8 sm:py-10">
        <div className="max-w-[1360px] mx-auto px-5 sm:px-8 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-5">
      ...
      <motion.a href="https://wa.me/34653046233?text=Hola%2C%20me%20gustar%C3%ADa%20solicitar%20un%20presupuesto"
        ...
        className="fixed bottom-5 sm:bottom-8 right-4 sm:right-8 z-50 group flex items-center overflow-hidden">
        <div className="bg-[#25D366] max-w-0 group-hover:max-w-[150px] overflow-hidden whitespace-nowrap px-0 group-hover:px-4 py-3.5 text-white text-[10px] tracking-widest uppercase font-light transition-all duration-500 hidden sm:block">WhatsApp</div>
        <div className="w-11 h-11 sm:w-14 sm:h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl shadow-[#25D366]/20 flex-shrink-0">
          <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6 fill-white"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" /></svg>
        </div>
      </motion.a>
